...
export function SettingsPage() {
  ...
  const dashboardImageRef = useRef<HTMLInputElement>(null);
  ...
  useEffect(() => {
    ...
    const savedDashboardImage =
      localStorage.getItem(DASHBOARD_IMAGE_KEY) || '';

    setDashboardImage(savedDashboardImage);
  }, [load]);
      ...
      <div className="pt-4">
        ...
        <Card className="p-4 mb-4">
          ...
          <p className="text-[11px] text-slate-500 mb-4">
            اختر صورة كرين أو معدات لتظهر في أعلى الصفحة الرئيسية
          </p>
          ...
          >
            ...
            {dashboardImage && (
              <div
                ...
                style={{
                  background:
                    'linear-gradient(180deg, transparent 35%, rgba(3,8,17,0.65))',
                }}
              />
            )}
            ...
            {dashboardImage && (
              <div className="absolute bottom-3 right-3">
                ...
                <span className="px-3 py-1.5 rounded-xl bg-black/50 border border-white/10 text-[10px] text-white">
                  BAAKR PRO
                </span>
          ...
          <div className="grid grid-cols-2 gap-2 mt-3">
            ...
            <button
              type="button"
              disabled={!dashboardImage}
              onClick={removeDashboardImage}
          ...
          <p className="text-[10px] text-slate-600 text-center mt-3">
            يمكنك تغيير الصورة في أي وقت من معرض الجوال
          </p>
