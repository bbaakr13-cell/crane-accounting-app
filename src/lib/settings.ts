  ...
  return new Promise((resolve, reject) => {
    ...
    reader.onload = () => {
      ...
      img.onload = () => {
        ...
        if (!width || !height) {
          reject(
            new Error('أبعاد الصورة غير صحيحة')
          );
          return;
        }
...
export function SettingsPage() {
  ...
  async function logo(
    ...
    try {
      ...
      showMessage(
        'تم تجهيز الشعار، اضغط حفظ جميع الإعدادات'
      );
    } catch (error) {
      console.error(error);
  ...
  async function changeDashboardImage(
    ...
    try {
      ...
      try {
        ...
        showMessage(
          'مساحة التخزين غير كافية للصورة',
          'error'
        );
    ...
    >
      <div className="pt-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-slate-500 mt-1">
                اختر شعار BAAKR PRO من صور الجوال
              </p>
        ...
        <Card className="p-4 mb-4">
          ...
          <div className="flex items-center gap-2 text-gold-400 mb-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-500 mt-1">
                الصورة التي تظهر أعلى الصفحة الرئيسية
              </p>
            </div>
          ...
          <div
            className="relative w-full overflow-hidden rounded-[22px] mt-4"
            style={{
              height: 145,
              background:
          ...
          >
            ...
            {dashboardImage ? (
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <Truck
                  className="w-12 h-12 text-gold-400/30"
                  strokeWidth={1.4}
                />

                <p className="text-xs text-slate-500 mt-2">
                  اختر صورة كرين من الجوال
                </p>
            ...
            {dashboardImage && (
              <div
                ...
                style={{
                  background:
                    'linear-gradient(180deg, transparent 35%, rgba(3,8,17,0.72))',
                }}
              />
            )}
            ...
            {dashboardImage && (
              <div className="absolute bottom-3 right-3">
                ...
                <span className="px-3 py-1.5 rounded-xl bg-black/55 border border-white/10 text-[10px] text-white font-bold">
                  BAAKR PRO
                </span>
          ...
          <div className="grid grid-cols-2 gap-2 mt-3">
            ...
            <button
              ...
              className="h-11 rounded-xl bg-gold-500/10 border border-gold-500/20 text-gold-400 text-xs font-bold flex items-center justify-center gap-2 active:scale-[0.98]"
            >
          ...
          <p className="text-[10px] text-slate-600 text-center mt-3">
            يتم ضغط الصورة تلقائيًا وحفظها فورًا
          </p>
        ...
        {msg && (
          <div
            className={`mb-3 rounded-xl border py-3 px-4 text-center ${
              msgType ===
              'success'
        ...
        <button
          ...
          onClick={save}
          disabled={saving}
          className="w-full py-3.5 rounded-xl bg-gradient-to-br from-gold-400 to-gold-600 text-ink-950 font-bold flex items-center justify-center gap-2 disabled:opacity-70"
        >
        ...
        <button
          ...
          onClick={() => {
            ...
            showMessage(
              'تم تحميل الإعدادات الافتراضية، اضغط حفظ لتأكيدها'
            );
          }}
