...
const InvoicePreview = React.forwardRef<HTMLDivElement, { data: InvoiceData; total: number; totalWords: string; theme: string }>(({ data, total, totalWords, theme }, ref) => (
  ...
  >
    ...
    >
      <div
        style={{
          ...
          padding: '12px 14px',
          background:
            'linear-gradient(145deg,#ffffff 0%,#f8fafc 55%,#eef3f8 100%)',
        }}
      >
        {/* يسار */}
        <div
        ...
        >
          <Truck size={82} strokeWidth={1.65} />
        </div>
      </div>
    </div>

    {/* عنوان الفاتورة + الرقم والتاريخ */}
    <div
      style={{
        display: 'grid',
    ...
    >
      ...
      >
        <div style={{ fontSize: 15 }}>No</div>
        <div style={{ fontSize: 27 }}>{data.invoiceNo}</div>
      </div>
      ...
      >
        <div style={{ fontSize: 25, fontWeight: 900 }}>فاتورة نقداً</div>
        <div
          dir="ltr"
          style={{
            marginTop: 3,
      ...
      >
        ...
        <div>{data.date}</div>
        <div style={{ marginTop: 2 }}>المطلوب من السيد / السادة</div>
      </div>
    </div>
      ...
      >
        <thead>
          <tr>
            ...
            <th style={{ ...invoiceTh(theme), width: '36%' }}>
              البيان
              <small style={englishSmall}>Description</small>
            </th>

            <th style={{ ...invoiceTh(theme), width: '14%' }}>
              الكمية
              <small style={englishSmall}>Qty.</small>
            </th>

            <th style={{ ...invoiceTh(theme), width: '20%' }}>
              سعر الوحدة
              <small style={englishSmall}>Unit Price S.R.</small>
            </th>

            <th style={{ ...invoiceTh(theme), width: '23%' }}>
              السعر الإجمالي
              <small style={englishSmall}>Total Price S.R.</small>
            </th>
          </tr>
        </thead>
    ...
    >
      ...
      >
        <SummaryRow theme={theme} label="المجموع">
          <strong style={{ fontSize: 18 }}>
            {total.toLocaleString()} ر.س
          </strong>
        </SummaryRow>

        <SummaryRow theme={theme} label="المبلغ كتابة">
          <span style={{ fontWeight: 700 }}>{totalWords}</span>
        </SummaryRow>

        <SummaryRow theme={theme} label="ملاحظات">
          <span
            style={{
              whiteSpace: 'pre-line',
              fontWeight: 700,
      ...
      >
        ...
        <DetailRow
          label="الموقع"
          value={data.customerLocation || data.companyLocation}
        />
      </div>
    </div>
    ...
    >
      <div>
        <strong style={{ fontSize: 14 }}>توقيع المستلم</strong>
        <div style={{ fontSize: 10, marginTop: 2 }}>Received</div>
        <div
          style={{
            width: 160,
            borderBottom: `2px dotted ${theme}`,
            margin: '27px auto 0',
          }}
        />
      </div>
      ...
      <div>
        <strong style={{ fontSize: 14 }}>توقيع البائع</strong>
