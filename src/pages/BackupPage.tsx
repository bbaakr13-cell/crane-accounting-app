...
export function BackupPage() {
  ...
  async function handleSaveToDrive() {
    ...
    try {
      ...
      showMessage(
        'تعذر تجهيز النسخة للحفظ في Google Drive',
        true
      );
    } finally {
      setWorking(false);
    ...
    >
      ...
      >
        ...
        >
          ...
          ويمكنك حفظ نسخة خارج الجهاز في
          Google Drive من الزر الموجود بالأعلى.
          كما يحتفظ التطبيق بآخر 7 نسخ يومية
          و4 نسخ أسبوعية.
        </div>
