 ...
 async function buildPdf(){
  ...
  report.innerHTML=`
    ...
    *{box-sizing:border-box} .page{width:794px;min-height:1123px;background:#fff;position:relative;padding-bottom:86px}
    ...
    .brand{position:absolute;left:34px;top:27px;text-align:left;direction:ltr}.brand-main{font-size:37px;font-weight:900;letter-spacing:1px}.brand-main span{color:#f5a623}.brand-sub{font-size:13px;font-weight:800;letter-spacing:2px;margin-top:5px;color:#f5a623}
    .w1{left:96px}.w2{left:146px}.hook{position:absolute;width:2px;height:55px;background:#f5a623;left:181px;top:8px}.hook:after{content:'J';font-size:22px;color:#f5a623;position:absolute;bottom:-17px;left:-3px;font-weight:900}
   ...
   <div class="page">
    <div class="hero">
      ...
      <div class="cab"></div><div class="wheel w1"></div><div class="wheel w2"></div><div class="hook"></div></div>
