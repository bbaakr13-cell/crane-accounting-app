...
export function PartnersPage(){
 ...
 async function buildPdf(){
  ...
  report.dir='rtl';
  report.style.cssText='position:fixed;left:-10000px;top:0;width:794px;height:1123px;background:#fff;color:#10233d;font-family:Arial,Tahoma,sans-serif;box-sizing:border-box;overflow:hidden;';
  ...
  report.innerHTML=`
   <style>
    *{box-sizing:border-box} .page{width:794px;height:1123px;background:#fff;position:relative;padding-bottom:86px}
    .hero{height:168px;background:linear-gradient(120deg,#03182e 0%,#062846 58%,#0a3558 100%);color:white;padding:26px 34px;position:relative;overflow:hidden;border-bottom:7px solid #f5a623}
    ...
    .brand{position:absolute;left:34px;top:30px;text-align:left;direction:ltr}.brand-main{font-size:34px;font-weight:900;letter-spacing:1px}.brand-main span{color:#f5a623}.brand-sub{font-size:13px;font-weight:800;letter-spacing:2px;margin-top:5px;color:#f5a623}
    
    .title{position:absolute;right:35px;top:24px;text-align:right}.title h1{font-size:30px;margin:0 0 4px;font-weight:900}.title .en{font-size:17px;letter-spacing:.7px;color:#dce8f2}.title .line{width:145px;height:3px;background:#f5a623;margin:12px 0 10px auto}.title .slogan{font-size:13px;color:#f5c96e;font-weight:700}
    .meta{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;padding:18px 28px 10px}.meta-card{background:#f5f8fc;border:1px solid #edf1f6;border-radius:12px;padding:12px;text-align:center;min-height:66px}.meta-label{font-size:10px;color:#66778a;margin-bottom:7px}.meta-value{font-size:13px;font-weight:900;color:#10233d}
    ...
    .totals{background:#eaf6ff!important;color:#0a3558;font-weight:900}.notes{margin-top:13px;background:#f7f9fc;border:1px solid #e6ebf1;border-radius:10px;padding:11px 15px;font-size:9px;line-height:1.8;color:#526274}.notes b{color:#0a3558;font-size:11px}
   ...
   <div class="page">
    <div class="hero">
      <div class="brand"><div class="brand-main">BAKR <span>AL-MASBAHI</span></div><div class="brand-sub">BAKR PRO</div></div>
      <div class="title"><h1>حساب الشركاء</h1><div class="en">PARTNERS ACCOUNT</div><div class="line"></div><div class="slogan">إدارة أسهل • نتائج أكبر</div></div>
    </div>
    <div class="meta">
    ...
    <div class="section" style="margin-top:15px">
      ...
      </div><div class="footer"><div class="footer-brand">BAKR <span>AL-MASBAHI</span><small>BAKR PRO</small></div><div class="footer-mid"><b>إدارة حسابات</b>SMART MANAGEMENT</div><div class="footer-date">${issueDate}<br>BAKR AL-MASBAHI • BAKR PRO</div></div>
   </div>`;
