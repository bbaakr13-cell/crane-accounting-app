  ...
  const convert = (num: number): string => {
    ...
    if (num < 1000000) {
      ...
      if (thousands === 1) {
        ...
        t = `${under1000(thousands)} آلاف`;
      } else {
        t = `${under1000(thousands)} ألف`;
      }
...
function drawArabic(
  ...
  ctx.font =
    `400 ${finalSize}px "${ARABIC_FONT_NAME}"`;
...
export function WorkInvoicePage() {
  ...
  /* =======================================================
     اسم ملف PDF الاحترافي
     
     مثال:
     فاتورة-عمل_شركة-المياه-الوطنية_رقم-125_17-09-2026.pdf
  ======================================================= */
