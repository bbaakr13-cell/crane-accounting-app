...
export function MonthlyDetailPage() {
  ...
  function handleImportFile(
    ...
    if (
      ...
      alert(
        'الشهر مقفل. افتح الشهر للتعديل أولاً.'
      );
  ...
  function applyImportedRows() {
    ...
    if (
      ...
      const ok =
        window.confirm(
          `يوجد بيانات محفوظة مسبقاً في ${duplicateDays.length} يوم.\n\nعند المتابعة سيتم استبدال بيانات هذه الأيام بالبيانات المستوردة من الصورة.\n\nمتابعة؟`
        );
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                صوّر الحساب القديم أو اختر صورة من الجوال
              </div>
            </div>
